...
struct mpu_armv8m_region_cfg_t region_cfg1 = {
    0x1,
    0x20000000UL,
    0x20000FFFUL,
    ...
    MPU_ARMV8M_SH_NONE};
struct mpu_armv8m_region_cfg_t region_cfg2 = {
    0x2,
    0x20002000UL,
    0x20002FFFUL,
    MPU_ARMV8M_MAIR_ATTR_CODE_IDX,
    ...
    MPU_ARMV8M_AP_RW_PRIV_UNPRIV,
    MPU_ARMV8M_SH_NONE};
struct mpu_armv8m_region_cfg_t region_cfg3 = {
    0x3,
    0x20003000UL,
    0x20003FFFUL,
    MPU_ARMV8M_MAIR_ATTR_CODE_IDX,
    ...
    MPU_ARMV8M_AP_RW_PRIV_UNPRIV,
    MPU_ARMV8M_SH_NONE};
struct mpu_armv8m_region_cfg_t region_cfg0 = {
    0x0,
    0x0UL,
    0x8000UL,
    MPU_ARMV8M_MAIR_ATTR_CODE_IDX,
...
void mpu_enable()
{
    region_cfg0.region_base = NS_MPU_START;
    region_cfg0.region_limit = NS_MPU_END;
    mpu_armv8m_region_enable(&dev_mpu_ns, &region_cfg0);
    mpu_armv8m_region_enable(&dev_mpu_ns, &region_cfg1);
    mpu_armv8m_region_enable(&dev_mpu_ns, &region_cfg2);
    mpu_armv8m_region_enable(&dev_mpu_ns, &region_cfg3);

    mpu_armv8m_enable(&dev_mpu_ns, PRIVILEGED_DEFAULT_ENABLE, 0);
}
